...
namespace AWSLambdaJParse
{
    ...
    ";
        ...
        public static string ResponseSample = @"{
  'response': [
    {
    ...
    },
    {
      ...
      'title': 'The Originals'
        ...
        public static string T1RequestSample = RequestSample;
        public static string T1ResponseSample = ResponseSample;

        public static string T2RequestSample = @"{
    'payload': [],
    'skip': 0,
    'take': 10,
    'totalRecords': 75
    }";
        public static string T2ResponseSample = @"{
  'response': []
}";

        public static string T3RequestSample = @"{
    'payload': [
        {
            'country': 'UK',
            'description': 'What\'s life like when you have enough children to field your own football team?',
    ...
    'totalRecords': 75
        ...
        public static string T3ResponseSample = @"{
  'response': [
    {
      'image': 'http://mybeautifulcatchupservice.com/img/shows/Thunderbirds_1280.jpg',
      'slug': 'show/thunderbirds',
    ...
    },
    {
      ...
      'title': 'The Originals'
        ...
        public static string T1ErrRequestSample = @"{}";
        public static string T1ErrResponseSample = @"{
  'error': 'Could not decode request: JSON parsing failed - Payload not found in input JSON'
}";

        public static string T2ErrRequestSample = EmptySample;
        public static string T2ErrResponseSample = @"'error': 'Could not decode request:";

        public static string T3ErrRequestSample = @"{'payload':}";
        public static string T3ErrResponseSample = @"{
  'error': 'Could not decode request: JSON parsing failed - Unexpected character encountered while parsing value: }. Path 'payload', line 1, position 11.'
}";
        public static string T4ErrRequestSample = RequestSample.Replace("payload","pay");
        public static string T4ErrResponseSample = @"{
  'error': 'Could not decode request: JSON parsing failed - Payload not found in input JSON'
}";
